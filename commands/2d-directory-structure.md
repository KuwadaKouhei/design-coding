...
7. （Gitを使う場合）**1フェーズ＝1コミット**。このフェーズで作成・更新した `docs/DIRECTORY_STRUCTURE.md` を
   まとめて1コミットする（メッセージは `docs/GIT_CONVENTIONS.md` 準拠。例 `docs: ディレクトリ構造(DIRECTORY_STRUCTURE)を追加`）
